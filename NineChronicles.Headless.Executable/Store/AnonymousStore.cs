...
#pragma warning disable CS8618
    ...
    public Func<EvidenceId, Evidence?> GetPendingEvidence { get; set; }
    public Func<EvidenceId, Evidence?> GetCommittedEvidence { get; set; }
    public Action<Evidence> PutPendingEvidence { get; set; }
    public Action<Evidence> PutCommittedEvidence { get; set; }
...
#pragma warning restore CS8618
    ...
    Evidence? IStore.GetPendingEvidence(EvidenceId evidenceId)
    {
        return GetPendingEvidence(evidenceId);
    }

    Evidence? IStore.GetCommittedEvidence(EvidenceId evidenceId)
    {
        return GetCommittedEvidence(evidenceId);
    }

    void IStore.PutPendingEvidence(Evidence evidence)
    {
        PutPendingEvidence(evidence);
    }

    void IStore.PutCommittedEvidence(Evidence evidence)
    {
